...
cmake .. \
    ...
    -DUSE_CCACHE=ON \
    -Datlantis_USE_BUNDLED_SDL2=OFF \
    -Datlantis_USE_EXTERNAL_SDL2=OFF \
    -Datlantis_TESTS=OFF \
    -GNinja
ninja atlantis atlantis-cmd
...
find build/ -name "atlantis*.exe" -exec cp {} 'package' \;
...
# copy libraries from atlantis.exe path

...
/*
To play back TAS scripts on atlantis, select the folder with scripts in the configuration menu below
...
After placing the file at the correct location, it can be read into atlantis with the (default) hotkey

...
public:
     ...
     * @param j_input_device atlantisInputDevice object from the Android frontend to register.
     */
    ...
    /**
     * Gets the axes reported by the atlantisInputDevice.
     * @param env JNI environment pointer.
     * @param j_device atlantisInputDevice from the Android frontend.

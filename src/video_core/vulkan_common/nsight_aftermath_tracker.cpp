...
NsightAftermathTracker::NsightAftermathTracker() {
    ...
    dump_dir = Common::FS::GetatlantisPath(Common::FS::atlantisPath::LogDir) / "gpucrash";
...
void NsightAftermathTracker::OnCrashDumpDescriptionCallback(
    ...
    add_description(GFSDK_Aftermath_GpuCrashDumpDescriptionKey_ApplicationName, "atlantis");
}

...
std::pair<typename P::ImageView*, bool> TextureCache<P>::TryFindFramebufferImageView(
    ...
    const auto it = page_table.find(cpu_addr >> atlantis_PAGEBITS);
    ...
    const auto& clear_page_table =
        [image_id](u64 page,
            ...
            if (page_it == selected_page_table.end()) {
                ASSERT_MSG(false, "Unregistering unregistered page=0x{:x}", page << atlantis_PAGEBITS);
                return;
            }

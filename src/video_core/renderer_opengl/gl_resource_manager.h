...
public:
    atlantis_NON_COPYABLE(OGLRenderbuffer);
...
public:
    atlantis_NON_COPYABLE(OGLTexture);
...
public:
    atlantis_NON_COPYABLE(OGLTextureView);
...
public:
    atlantis_NON_COPYABLE(OGLSampler);
...
public:
    atlantis_NON_COPYABLE(OGLShader);
...
public:
    atlantis_NON_COPYABLE(OGLProgram);
...
public:
    atlantis_NON_COPYABLE(OGLAssemblyProgram);
...
public:
    atlantis_NON_COPYABLE(OGLPipeline);
...
public:
    atlantis_NON_COPYABLE(OGLBuffer);
...
public:
    atlantis_NON_COPYABLE(OGLFramebuffer);
...
public:
    atlantis_NON_COPYABLE(OGLQuery);
...
public:
    atlantis_NON_COPYABLE(OGLTransformFeedback);

...
class Packet {
public:
    atlantis_NON_COPYABLE(Packet);
    atlantis_NON_MOVEABLE(Packet);
...
class Frame {
public:
    atlantis_NON_COPYABLE(Frame);
    atlantis_NON_MOVEABLE(Frame);
...
class Decoder {
public:
    atlantis_NON_COPYABLE(Decoder);
    atlantis_NON_MOVEABLE(Decoder);
...
class HardwareContext {
public:
    atlantis_NON_COPYABLE(HardwareContext);
    atlantis_NON_MOVEABLE(HardwareContext);
...
class DecoderContext {
public:
    atlantis_NON_COPYABLE(DecoderContext);
    atlantis_NON_MOVEABLE(DecoderContext);
...
class DeinterlaceFilter {
public:
    atlantis_NON_COPYABLE(DeinterlaceFilter);
    atlantis_NON_MOVEABLE(DeinterlaceFilter);
...
class DecodeApi {
public:
    atlantis_NON_COPYABLE(DecodeApi);
    atlantis_NON_MOVEABLE(DecodeApi);

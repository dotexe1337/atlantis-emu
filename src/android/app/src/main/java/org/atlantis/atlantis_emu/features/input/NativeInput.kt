...
import org.atlantis.atlantis_emu.features.input.model.InputType
import org.atlantis.atlantis_emu.features.input.model.ButtonName
...
object NativeInput {
     ...
     * @param device An [InputDevice] or the input overlay wrapped with [atlantisInputDevice]
     */
    external fun registerController(device: atlantisInputDevice)

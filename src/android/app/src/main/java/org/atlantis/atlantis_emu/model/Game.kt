...
class Game(
    ...
    val saveZipName: String
        get() = "$title ${atlantisApplication.appContext.getString(R.string.save_data).lowercase()} - ${
    ...
    val launchIntent: Intent
        get() = Intent(atlantisApplication.appContext, EmulationActivity::class.java).apply {

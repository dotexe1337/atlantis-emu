...
import org.atlantis.atlantis_emu.databinding.ListItemInputProfileBinding
...
data class NewProfileItem(
    ...
    override val name: String = atlantisApplication.appContext.getString(R.string.create_new_profile)
}

...
object GpuDriverHelper {
    ...
    fun initializeDriverParameters() {
        try {
            ...
            fileRedirectionPath = atlantisApplication.appContext
                .getExternalFilesDir(null)!!.canonicalPath + "/gpu/vk_file_redirect/"

            // Initialize the driver installation directory.
            driverInstallationPath = atlantisApplication.appContext
        ...
        hookLibPath = atlantisApplication.appContext.applicationInfo.nativeLibraryDir + "/"

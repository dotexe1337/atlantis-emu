...
import org.atlantis.atlantis_emu.databinding.FragmentSearchBinding
...
class SearchFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        preferences = PreferenceManager.getDefaultSharedPreferences(atlantisApplication.appContext)

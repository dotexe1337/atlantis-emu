...
package org.atlantis.atlantis_emu.features.settings.model.view
...
import org.atlantis.atlantis_emu.features.settings.model.AbstractSetting
...
abstract class SettingsItem(
    ...
    val title: String by lazy {
        if (titleId != 0) {
            return@lazy atlantisApplication.appContext.getString(titleId)
        }
    ...
    val description: String by lazy {
        if (descriptionId != 0) {
            return@lazy atlantisApplication.appContext.getString(descriptionId)
        }

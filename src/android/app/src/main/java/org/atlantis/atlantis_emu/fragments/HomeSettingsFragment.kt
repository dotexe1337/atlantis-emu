...
import org.atlantis.atlantis_emu.BuildConfig
...
import org.atlantis.atlantis_emu.adapters.HomeSettingAdapter
import org.atlantis.atlantis_emu.databinding.FragmentHomeSettingsBinding
import org.atlantis.atlantis_emu.features.DocumentProvider
import org.atlantis.atlantis_emu.features.settings.model.Settings
import org.atlantis.atlantis_emu.model.DriverViewModel
import org.atlantis.atlantis_emu.model.HomeSetting
import org.atlantis.atlantis_emu.model.HomeViewModel
import org.atlantis.atlantis_emu.ui.main.MainActivity
...
class HomeSettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val optionsList: MutableList<HomeSetting> = mutableListOf<HomeSetting>().apply {
            ...
            add(
                HomeSetting(
                    R.string.manage_atlantis_data,
                    R.string.manage_atlantis_data_description,
                    ...
                    R.drawable.ic_check_circle,
                    {
                        ProgressDialogFragment.newInstance(
                            ...
                            return@newInstance if (progressCallback.invoke(100, 100)) {
                                ...
                                val errorMessage = atlantisApplication.appContext.getString(
    ...
    private fun shareLog() {
        val currentLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                ...
                "${DocumentProvider.ROOT_ID}/log/atlantis_log.txt"
            )
        )!!
        val oldLog = DocumentFile.fromSingleUri(
            ...
            DocumentsContract.buildDocumentUri(
                DocumentProvider.AUTHORITY,
                "${DocumentProvider.ROOT_ID}/log/atlantis_log.txt.old.txt"
            )
        )!!

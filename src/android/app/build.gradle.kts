...
android {
    namespace = "org.atlantis.atlantis_emu"
    ...
    defaultConfig {
        ...
        applicationId = "org.atlantis.atlantis_emu"
        minSdk = 30
        targetSdk = 34
    ...
    buildTypes {
        ...
        release {
            ...
            resValue("string", "app_name_suffixed", "atlantis")
        ...
        register("relWithDebInfo") {
            isDefault = true
            resValue("string", "app_name_suffixed", "atlantis Debug Release")
        ...
        debug {
            signingConfig = signingConfigs.getByName("default")
            resValue("string", "app_name_suffixed", "atlantis Debug")
            isDebuggable = true
            isJniDebuggable = true
        ...
        externalNativeBuild {
            cmake {
                arguments(
                    ...
                    "-Datlantis_USE_BUNDLED_VCPKG=ON",

...
void Config::Initialize(const std::string& config_name) {
    const std::filesystem::path fs_config_loc = FS::GetatlantisPath(FS::atlantisPath::ConfigDir);
...
void Config::Initialize(const std::optional<std::string> config_path) {
    const std::filesystem::path default_sdl_config_path =
        FS::GetatlantisPath(FS::atlantisPath::ConfigDir) / "sdl2-config.ini";
...
void Config::ReadDataStorageValues() {
    ...
    FS::SetatlantisPath(FS::atlantisPath::NANDDir, ReadStringSetting(std::string("nand_directory")));
    FS::SetatlantisPath(FS::atlantisPath::SDMCDir, ReadStringSetting(std::string("sdmc_directory")));
    FS::SetatlantisPath(FS::atlantisPath::LoadDir, ReadStringSetting(std::string("load_directory")));
    FS::SetatlantisPath(FS::atlantisPath::DumpDir, ReadStringSetting(std::string("dump_directory")));
    FS::SetatlantisPath(FS::atlantisPath::TASDir, ReadStringSetting(std::string("tas_directory")));
...
void Config::ReadScreenshotValues() {
    ...
    FS::SetatlantisPath(FS::atlantisPath::ScreenshotsDir,
...
void Config::SaveDataStorageValues() {
    ...
    WriteStringSetting(std::string("nand_directory"), FS::GetatlantisPathString(FS::atlantisPath::NANDDir),
                       std::make_optional(FS::GetatlantisPathString(FS::atlantisPath::NANDDir)));
    WriteStringSetting(std::string("sdmc_directory"), FS::GetatlantisPathString(FS::atlantisPath::SDMCDir),
                       std::make_optional(FS::GetatlantisPathString(FS::atlantisPath::SDMCDir)));
    WriteStringSetting(std::string("load_directory"), FS::GetatlantisPathString(FS::atlantisPath::LoadDir),
                       std::make_optional(FS::GetatlantisPathString(FS::atlantisPath::LoadDir)));
    WriteStringSetting(std::string("dump_directory"), FS::GetatlantisPathString(FS::atlantisPath::DumpDir),
                       std::make_optional(FS::GetatlantisPathString(FS::atlantisPath::DumpDir)));
    WriteStringSetting(std::string("tas_directory"), FS::GetatlantisPathString(FS::atlantisPath::TASDir),
                       std::make_optional(FS::GetatlantisPathString(FS::atlantisPath::TASDir)));
...
void Config::SaveScreenshotValues() {
    ...
    WriteStringSetting(std::string("screenshot_path"),
                       FS::GetatlantisPathString(FS::atlantisPath::ScreenshotsDir));

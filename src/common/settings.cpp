...
void LogSettings() {
    ...
    LOG_INFO(Config, "atlantis Configuration:");
    for (auto& [category, settings] : values.linkage.by_category) {
        for (const auto& setting : settings) {
            if (setting->Id() == values.atlantis_token.Id()) {
    ...
    log_path("DataStorage_CacheDir", Common::FS::GetatlantisPath(Common::FS::atlantisPath::CacheDir));
    log_path("DataStorage_ConfigDir", Common::FS::GetatlantisPath(Common::FS::atlantisPath::ConfigDir));
    log_path("DataStorage_LoadDir", Common::FS::GetatlantisPath(Common::FS::atlantisPath::LoadDir));
    log_path("DataStorage_NANDDir", Common::FS::GetatlantisPath(Common::FS::atlantisPath::NANDDir));
    log_path("DataStorage_SDMCDir", Common::FS::GetatlantisPath(Common::FS::atlantisPath::SDMCDir));
}

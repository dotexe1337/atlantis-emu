...
static jclass s_atlantis_input_device_interface;
static jmethodID s_atlantis_input_device_get_name;
static jmethodID s_atlantis_input_device_get_guid;
static jmethodID s_atlantis_input_device_get_port;
static jmethodID s_atlantis_input_device_get_supports_vibration;
static jmethodID s_atlantis_input_device_vibrate;
static jmethodID s_atlantis_input_device_get_axes;
static jmethodID s_atlantis_input_device_has_keys;
...
jclass GetatlantisInputDeviceInterface() {
    return s_atlantis_input_device_interface;
}

jmethodID GetatlantisDeviceGetName() {
    return s_atlantis_input_device_get_name;
}

jmethodID GetatlantisDeviceGetGUID() {
    return s_atlantis_input_device_get_guid;
}

jmethodID GetatlantisDeviceGetPort() {
    return s_atlantis_input_device_get_port;
}

jmethodID GetatlantisDeviceGetSupportsVibration() {
    return s_atlantis_input_device_get_supports_vibration;
}

jmethodID GetatlantisDeviceVibrate() {
    return s_atlantis_input_device_vibrate;
}

jmethodID GetatlantisDeviceGetAxes() {
    return s_atlantis_input_device_get_axes;
}

jmethodID GetatlantisDeviceHasKeys() {
    return s_atlantis_input_device_has_keys;
}
...
jint JNI_OnLoad(JavaVM* vm, void* reserved) {
    ...
    const jclass native_library_class = env->FindClass("org/atlantis/atlantis_emu/NativeLibrary");
    s_native_library_class = reinterpret_cast<jclass>(env->NewGlobalRef(native_library_class));
    s_disk_cache_progress_class = reinterpret_cast<jclass>(env->NewGlobalRef(
        env->FindClass("org/atlantis/atlantis_emu/disk_shader_cache/DiskShaderCacheProgress")));
    s_load_callback_stage_class = reinterpret_cast<jclass>(env->NewGlobalRef(env->FindClass(
        "org/atlantis/atlantis_emu/disk_shader_cache/DiskShaderCacheProgress$LoadCallbackStage")));

    const jclass game_dir_class = env->FindClass("org/atlantis/atlantis_emu/model/GameDir");
    ...
    const jclass game_class = env->FindClass("org/atlantis/atlantis_emu/model/Game");
    ...
    const jclass overlay_control_data_class =
        env->FindClass("org/atlantis/atlantis_emu/overlay/model/OverlayControlData");
    ...
    const jclass patch_class = env->FindClass("org/atlantis/atlantis_emu/model/Patch");
    ...
    const jclass player_input_class =
        env->FindClass("org/atlantis/atlantis_emu/features/input/model/PlayerInput");
    ...
    const jclass atlantis_input_device_interface =
        env->FindClass("org/atlantis/atlantis_emu/features/input/atlantisInputDevice");
    s_atlantis_input_device_interface =
        reinterpret_cast<jclass>(env->NewGlobalRef(atlantis_input_device_interface));
    s_atlantis_input_device_get_name =
        env->GetMethodID(atlantis_input_device_interface, "getName", "()Ljava/lang/String;");
    s_atlantis_input_device_get_guid =
        env->GetMethodID(atlantis_input_device_interface, "getGUID", "()Ljava/lang/String;");
    s_atlantis_input_device_get_port = env->GetMethodID(atlantis_input_device_interface, "getPort", "()I");
    s_atlantis_input_device_get_supports_vibration =
        env->GetMethodID(atlantis_input_device_interface, "getSupportsVibration", "()Z");
    s_atlantis_input_device_vibrate = env->GetMethodID(atlantis_input_device_interface, "vibrate", "(F)V");
    s_atlantis_input_device_get_axes =
        env->GetMethodID(atlantis_input_device_interface, "getAxes", "()[Ljava/lang/Integer;");
    s_atlantis_input_device_has_keys =
        env->GetMethodID(atlantis_input_device_interface, "hasKeys", "([I)[Z");
    env->DeleteLocalRef(atlantis_input_device_interface);
...
void JNI_OnUnload(JavaVM* vm, void* reserved) {
    ...
    env->DeleteGlobalRef(s_atlantis_input_device_interface);

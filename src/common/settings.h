...
struct Values {
    ...
    Setting<std::string> device_name{
        linkage, "atlantis", "device_name", Category::System, Specialization::Default, true, true};
...
// Only read/write enable_raw_input on Windows platforms
    ...
    Setting<std::string> web_api_url{linkage, "https://api.atlantis-emu.org", "web_api_url",
                                     Category::WebService};
    Setting<std::string> atlantis_username{linkage, std::string(), "atlantis_username",
                                       Category::WebService};
    Setting<std::string> atlantis_token{linkage, std::string(), "atlantis_token", Category::WebService};

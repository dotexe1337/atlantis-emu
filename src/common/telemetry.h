...
enum class FieldType : u8 {
    ...
    App,          ///< atlantis application fields (e.g. version, branch, etc.)
...
public:
    atlantis_NON_COPYABLE(FieldCollection);
...
struct NullVisitor final : public VisitorInterface {
    atlantis_NON_COPYABLE(NullVisitor);

...
static u64 GenerateTelemetryId() {
    ...
    static constexpr std::array<char, 18> personalization{{"atlantis Telemetry ID"}};
...
u64 GetTelemetryId() {
    u64 telemetry_id{};
    const auto filename = Common::FS::GetatlantisPath(Common::FS::atlantisPath::ConfigDir) / "telemetry_id";
...
TelemetrySession::~TelemetrySession() {
    ...
    auto backend = std::make_unique<WebService::TelemetryJson>(
        Settings::values.web_api_url.GetValue(), Settings::values.atlantis_username.GetValue(),

...
public:
    atlantis_NON_COPYABLE(KMemoryRegion);
    atlantis_NON_MOVEABLE(KMemoryRegion);
...
public:
    atlantis_NON_COPYABLE(KMemoryRegionTree);
    atlantis_NON_MOVEABLE(KMemoryRegionTree);
...
public:
    atlantis_NON_COPYABLE(KMemoryRegionAllocator);
    atlantis_NON_MOVEABLE(KMemoryRegionAllocator);

...
void ExtractSharedFonts(Core::System& system) {
    ...
    const auto fonts_dir = Common::FS::GetatlantisPath(Common::FS::atlantisPath::CacheDir) / "fonts";
...
void WebBrowser::InitializeOffline() {
    ...
    offline_cache_dir = Common::FS::GetatlantisPath(Common::FS::atlantisPath::CacheDir) /

// SPDX-FileCopyrightText: 2022 atlantis Emulator Project
...
using Core::Memory::atlantis_PAGESIZE;
constexpr size_t BIG_PAGE_SIZE = atlantis_PAGESIZE * 16;
...
NvResult NvMap::Handle::Alloc(Flags pFlags, u32 pAlign, u8 pKind, u64 pAddress,
    ...
    flags = pFlags;
    kind = pKind;
    align = pAlign < atlantis_PAGESIZE ? atlantis_PAGESIZE : pAlign;
    ...
    size = Common::AlignUp(size, atlantis_PAGESIZE);

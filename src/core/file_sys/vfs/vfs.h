...
class VfsFilesystem {
public:
    atlantis_NON_COPYABLE(VfsFilesystem);
    atlantis_NON_MOVEABLE(VfsFilesystem);
...
class VfsFile {
public:
    atlantis_NON_COPYABLE(VfsFile);
    atlantis_NON_MOVEABLE(VfsFile);
...
class VfsDirectory {
public:
    atlantis_NON_COPYABLE(VfsDirectory);
    atlantis_NON_MOVEABLE(VfsDirectory);

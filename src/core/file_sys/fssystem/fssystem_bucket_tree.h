...
class BucketTree {
    atlantis_NON_COPYABLE(BucketTree);
    atlantis_NON_MOVEABLE(BucketTree);
...
private:
    class NodeBuffer {
        atlantis_NON_COPYABLE(NodeBuffer);
...
class BucketTree::Visitor {
    atlantis_NON_COPYABLE(Visitor);
    atlantis_NON_MOVEABLE(Visitor);

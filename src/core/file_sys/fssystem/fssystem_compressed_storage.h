...
class CompressedStorage : public IReadOnlyStorage {
    atlantis_NON_COPYABLE(CompressedStorage);
    atlantis_NON_MOVEABLE(CompressedStorage);
...
private:
    class CompressedStorageCore {
        atlantis_NON_COPYABLE(CompressedStorageCore);
        atlantis_NON_MOVEABLE(CompressedStorageCore);
    ...
    class CacheManager {
        atlantis_NON_COPYABLE(CacheManager);
        atlantis_NON_MOVEABLE(CacheManager);

...
class NcaReader {
    atlantis_NON_COPYABLE(NcaReader);
    atlantis_NON_MOVEABLE(NcaReader);
...
class NcaFsHeaderReader {
    atlantis_NON_COPYABLE(NcaFsHeaderReader);
    atlantis_NON_MOVEABLE(NcaFsHeaderReader);
...
class NcaFileSystemDriver {
    atlantis_NON_COPYABLE(NcaFileSystemDriver);
    atlantis_NON_MOVEABLE(NcaFileSystemDriver);

...
class AlignmentMatchingStorage : public IStorage {
    atlantis_NON_COPYABLE(AlignmentMatchingStorage);
    atlantis_NON_MOVEABLE(AlignmentMatchingStorage);
...
class AlignmentMatchingStoragePooledBuffer : public IStorage {
    atlantis_NON_COPYABLE(AlignmentMatchingStoragePooledBuffer);
    atlantis_NON_MOVEABLE(AlignmentMatchingStoragePooledBuffer);

...
public:
    ...
    // poses quite a challenge. Instead of creating a new meta NCA for this file, atlantis will create a
    // dir inside the NAND called 'atlantis_meta' and store the raw CNMT there.
...
private:
    ...
    bool RawInstallatlantisMeta(const CNMT& cnmt);
    ...
    // maps tid -> meta for CNMT in atlantis_meta
    std::map<u64, CNMT> atlantis_meta;
};

...
#include "atlantis/multiplayer/direct_connect.h"
...
DirectConnectWindow::DirectConnectWindow(Core::System& system_, QWidget* parent)
    ...
    if (ui->nickname->text().isEmpty() && !Settings::values.atlantis_username.GetValue().empty()) {
        // Use atlantis Web Service user name as nickname by default
        ui->nickname->setText(QString::fromStdString(Settings::values.atlantis_username.GetValue()));
    }

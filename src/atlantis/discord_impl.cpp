...
DiscordImpl::DiscordImpl(Core::System& system_) : system{system_} {
    ...
    // The number is the client ID for atlantis, it's used for images and the
    // application name
...
void DiscordImpl::UpdateGameStatus(bool use_default) {
    const std::string default_text = "atlantis is an emulator for the Nintendo Switch";
    const std::string default_image = "atlantis_logo";
...
void DiscordImpl::Update() {
    ...
    if (system.IsPoweredOn()) {
        ...
        // Used to format Icon URL for atlantis website game compatibility page
        std::string icon_name = GetGameString(game_title);
        game_url = fmt::format("https://atlantis-emu.org/images/game/boxart/{}.png", icon_name);

...
#include "atlantis/configuration/configure_tas.h"
...
void ConfigureTasDialog::LoadConfiguration() {
    ui->tas_path_edit->setText(
        QString::fromStdString(Common::FS::GetatlantisPathString(Common::FS::atlantisPath::TASDir)));
...
void ConfigureTasDialog::ApplyConfiguration() {
    Common::FS::SetatlantisPath(Common::FS::atlantisPath::TASDir, ui->tas_path_edit->text().toStdString());

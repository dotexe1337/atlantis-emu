...
void ConfigureWeb::RetranslateUI() {
    ...
    ui->telemetry_learn_more->setText(
        tr("<a href='https://atlantis-emu.org/help/feature/telemetry/'><span style=\"text-decoration: "
           "underline; color:#039be5;\">Learn more</span></a>"));

    ui->web_signup_link->setText(
        tr("<a href='https://profile.atlantis-emu.org/'><span style=\"text-decoration: underline; "
           "color:#039be5;\">Sign up</span></a>"));

    ui->web_token_info_link->setText(
        tr("<a href='https://atlantis-emu.org/wiki/atlantis-web-service/'><span style=\"text-decoration: "
...
void ConfigureWeb::SetConfiguration() {
    ...
    ui->edit_token->setText(QString::fromStdString(GenerateDisplayToken(
        Settings::values.atlantis_username.GetValue(), Settings::values.atlantis_token.GetValue())));
...
void ConfigureWeb::ApplyConfiguration() {
    ...
    if (user_verified) {
        Settings::values.atlantis_username =
            UsernameFromDisplayToken(ui->edit_token->text().toStdString());
        Settings::values.atlantis_token = TokenFromDisplayToken(ui->edit_token->text().toStdString());
    } else {
        QMessageBox::warning(

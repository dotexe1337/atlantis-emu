// SPDX-FileCopyrightText: Copyright 2019 atlantis Emulator Project
...
void ConfigureFilesystem::SetConfiguration() {
    ui->nand_directory_edit->setText(
        QString::fromStdString(Common::FS::GetatlantisPathString(Common::FS::atlantisPath::NANDDir)));
    ui->sdmc_directory_edit->setText(
        QString::fromStdString(Common::FS::GetatlantisPathString(Common::FS::atlantisPath::SDMCDir)));
    ui->gamecard_path_edit->setText(
        QString::fromStdString(Settings::values.gamecard_path.GetValue()));
    ui->dump_path_edit->setText(
        QString::fromStdString(Common::FS::GetatlantisPathString(Common::FS::atlantisPath::DumpDir)));
    ui->load_path_edit->setText(
        QString::fromStdString(Common::FS::GetatlantisPathString(Common::FS::atlantisPath::LoadDir)));
...
void ConfigureFilesystem::ApplyConfiguration() {
    Common::FS::SetatlantisPath(Common::FS::atlantisPath::NANDDir,
                            ui->nand_directory_edit->text().toStdString());
    Common::FS::SetatlantisPath(Common::FS::atlantisPath::SDMCDir,
                            ui->sdmc_directory_edit->text().toStdString());
    Common::FS::SetatlantisPath(Common::FS::atlantisPath::DumpDir,
                            ui->dump_path_edit->text().toStdString());
    Common::FS::SetatlantisPath(Common::FS::atlantisPath::LoadDir,
...
void ConfigureFilesystem::ResetMetadata() {
    if (!Common::FS::Exists(Common::FS::GetatlantisPath(Common::FS::atlantisPath::CacheDir) /
                            "game_list/")) {

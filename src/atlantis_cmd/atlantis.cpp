...
#include "atlantis_cmd/emu_window/emu_window_sdl2_gl.h"
#include "atlantis_cmd/emu_window/emu_window_sdl2_null.h"
#include "atlantis_cmd/emu_window/emu_window_sdl2_vk.h"
...
static void PrintVersion() {
    std::cout << "atlantis " << Common::g_scm_branch << " " << Common::g_scm_desc << std::endl;
}
    ...
    default:
        if (static_cast<u32>(load_result) >
            ...
            LOG_CRITICAL(Frontend,
                         ...
                         "refer to the atlantis wiki for more information or the atlantis discord for "
                         "additional help.\n\nError Code: {:04X}-{:04X}\nError Description: {}",

...
#ifdef atlantis_USE_EXTERNAL_SDL2
...
EmuWindow_SDL2_Null::EmuWindow_SDL2_Null(InputCommon::InputSubsystem* input_subsystem_,
    ...
    const std::string window_title = fmt::format("atlantis {} | {}-{} (Vulkan)", Common::g_build_name,
    ...
    SDL_PumpEvents();
    LOG_INFO(Frontend, "atlantis Version: {} | {}-{} (Null)", Common::g_build_name,
             Common::g_scm_branch, Common::g_scm_desc);
}
